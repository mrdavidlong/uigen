  ...
  return (
    <FileSystemProvider initialData={project?.data}>
      <ChatProvider projectId={project?.id} initialMessages={project?.messages}>
        <div className="h-screen w-screen overflow-hidden bg-blue-50" suppressHydrationWarning>
          <ResizablePanelGroup direction="horizontal" className="h-full">
            ...
            <ResizablePanel defaultSize={65}>
              <div className="h-full flex flex-col bg-white">
                {/* Top Bar */}
                <div className="h-14 border-b border-neutral-200/60 px-6 flex items-center justify-between bg-blue-50/50">
                  <Tabs
                    value={activeView}
                    onValueChange={(v) =>
                  ...
                  {activeView === "preview" ? (
                    ...
                    >
                      ...
                      <ResizablePanel
                        ...
                        maxSize={50}
                      >
                        <div className="h-full bg-blue-50 border-r border-neutral-200">
                          <FileTree />
                        </div>
                      </ResizablePanel>
